...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerHeIynsA\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerHeIynsA/UriSignerGhostB68a0a1.php';
require __DIR__.'/ContainerHeIynsA/EntityManagerGhost614a58f.php';
require __DIR__.'/ContainerHeIynsA/RequestPayloadValueResolverGhost01ca9cc.php';
require __DIR__.'/ContainerHeIynsA/ProfilerProxy8977808.php';
require __DIR__.'/ContainerHeIynsA/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerHeIynsA/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerHeIynsA/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_WhenService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_ExpressionService.php';
require __DIR__.'/ContainerHeIynsA/getValidator_EmailService.php';
require __DIR__.'/ContainerHeIynsA/getUriSignerService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerHeIynsA/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerHeIynsA/getTurbo_Twig_RuntimeService.php';
require __DIR__.'/ContainerHeIynsA/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerHeIynsA/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerHeIynsA/getTexter_TransportsService.php';
require __DIR__.'/ContainerHeIynsA/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/ContainerHeIynsA/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/ContainerHeIynsA/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/ContainerHeIynsA/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerHeIynsA/getSession_FactoryService.php';
require __DIR__.'/ContainerHeIynsA/getServicesResetterService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_Authenticator_FormLogin_MainService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerHeIynsA/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerHeIynsA/getSecrets_VaultService.php';
require __DIR__.'/ContainerHeIynsA/getSecrets_EnvVarLoaderService.php';
require __DIR__.'/ContainerHeIynsA/getRouting_LoaderService.php';
require __DIR__.'/ContainerHeIynsA/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerHeIynsA/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerHeIynsA/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerHeIynsA/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerHeIynsA/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/ContainerHeIynsA/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/ContainerHeIynsA/getMonolog_LoggerService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Transport_InMemory_FactoryService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/ContainerHeIynsA/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerHeIynsA/getMailer_TransportsService.php';
require __DIR__.'/ContainerHeIynsA/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerHeIynsA/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerHeIynsA/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerHeIynsA/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerHeIynsA/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Password_PasswordHasherService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Form_PasswordHasherService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerHeIynsA/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Type_FormService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Type_FileService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Type_EntityService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Type_ColorService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerHeIynsA/getForm_ServerParamsService.php';
require __DIR__.'/ContainerHeIynsA/getForm_RegistryService.php';
require __DIR__.'/ContainerHeIynsA/getForm_Listener_PasswordHasherService.php';
require __DIR__.'/ContainerHeIynsA/getForm_FactoryService.php';
require __DIR__.'/ContainerHeIynsA/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerHeIynsA/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerHeIynsA/getErrorControllerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerHeIynsA/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerHeIynsA/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerHeIynsA/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerHeIynsA/getDebug_Security_Authenticator_FormLogin_MainService.php';
require __DIR__.'/ContainerHeIynsA/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerHeIynsA/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerHeIynsA/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerHeIynsA/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerHeIynsA/getContainer_GetenvService.php';
require __DIR__.'/ContainerHeIynsA/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerHeIynsA/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerHeIynsA/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerHeIynsA/getChartjs_BuilderService.php';
require __DIR__.'/ContainerHeIynsA/getCache_SystemClearerService.php';
require __DIR__.'/ContainerHeIynsA/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerHeIynsA/getCache_AppClearerService.php';
require __DIR__.'/ContainerHeIynsA/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/ContainerHeIynsA/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/ContainerHeIynsA/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/ContainerHeIynsA/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/ContainerHeIynsA/getTemplateControllerService.php';
require __DIR__.'/ContainerHeIynsA/getRedirectControllerService.php';
require __DIR__.'/ContainerHeIynsA/getProfilerControllerService.php';
require __DIR__.'/ContainerHeIynsA/getEmailVerifierService.php';
require __DIR__.'/ContainerHeIynsA/getUserRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getTrackingRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getSelectedHabitsRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getPostRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getOwnHabitRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getHabitRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getCategoryRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getAchievementRepositoryService.php';
require __DIR__.'/ContainerHeIynsA/getSelectedHabitsTypeService.php';
require __DIR__.'/ContainerHeIynsA/getSelectedHabitsItemTypeService.php';
require __DIR__.'/ContainerHeIynsA/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerHeIynsA/getOwnHabitTypeService.php';
require __DIR__.'/ContainerHeIynsA/getLoginFormTypeService.php';
require __DIR__.'/ContainerHeIynsA/getHabitTypeService.php';
require __DIR__.'/ContainerHeIynsA/getSummaryControllerService.php';
require __DIR__.'/ContainerHeIynsA/getRegistrationControllerService.php';
require __DIR__.'/ContainerHeIynsA/getProfileControllerService.php';
require __DIR__.'/ContainerHeIynsA/getMainPageControllerService.php';
require __DIR__.'/ContainerHeIynsA/getLoginControllerService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllerService.php';
require __DIR__.'/ContainerHeIynsA/getDashboardControllerService.php';
require __DIR__.'/ContainerHeIynsA/getCommunityControllerService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_ZHyJIs5_KernelregisterContainerConfigurationService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_ZHyJIs5_KernelloadRoutesService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_ZHyJIs5Service.php';
require __DIR__.'/ContainerHeIynsA/getRegistrationControllerregisterService.php';
require __DIR__.'/ContainerHeIynsA/getLoginControllerindexService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllertrackHabitsService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllernewHabitService.php';
require __DIR__.'/ContainerHeIynsA/getProfileControllerindexService.php';
require __DIR__.'/ContainerHeIynsA/getSummaryControllerindexService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllerHabitsService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_LJZ8OpService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_JsQaLu1Service.php';
require __DIR__.'/ContainerHeIynsA/getProfileControllershareAchievementService.php';
require __DIR__.'/ContainerHeIynsA/get_ServiceLocator_ZyP9f7KService.php';
require __DIR__.'/ContainerHeIynsA/getCommunityControlleraddPostService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllerremoveHabitService.php';
require __DIR__.'/ContainerHeIynsA/getRegistrationControllerverifyUserEmailService.php';
require __DIR__.'/ContainerHeIynsA/getDashboardControllerHabitsService.php';
require __DIR__.'/ContainerHeIynsA/getHabitControllerselectHabitService.php';
require __DIR__.'/ContainerHeIynsA/get_Security_RequestMatcher_GOpgIHxService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_JyyWvHwService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_GEx8y9aService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_WG_ORBvService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_UKIJHilService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_Qv3faSNService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_NumTeF8Service.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_EXsqOW5Service.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_Dkv9sRYService.php';
require __DIR__.'/ContainerHeIynsA/get_Messenger_HandlerDescriptor_Die6BxeService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerHeIynsA/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Controller\HabitController';
...
$classes[] = 'App\Controller\SummaryController';
$classes[] = 'App\Form\HabitType';
$classes[] = 'App\Form\LoginFormType';
$classes[] = 'App\Form\OwnHabitType';
$classes[] = 'App\Form\RegistrationFormType';
$classes[] = 'App\Form\SelectedHabitsItemType';
$classes[] = 'App\Form\SelectedHabitsType';
$classes[] = 'App\Repository\AchievementRepository';
$classes[] = 'App\Repository\CategoryRepository';
$classes[] = 'App\Repository\HabitRepository';
$classes[] = 'App\Repository\OwnHabitRepository';
$classes[] = 'App\Repository\PostRepository';
$classes[] = 'App\Repository\SelectedHabitsRepository';
